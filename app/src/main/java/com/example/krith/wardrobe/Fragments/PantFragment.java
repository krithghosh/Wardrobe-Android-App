...
import com.example.krith.wardrobe.Adapters.ViewPagerAdapter_P;
...
public class PantFragment extends Fragment {
    ...
    public void onAttach(Activity activity) {
        ...
        adapter = new ViewPagerAdapter_P(activity);
    }
    ...
    public void onEvent(FavouriteEvent event) {
        Log.d("CurrentData ", "Pant- " + adapter.getCurrentItemData(viewPager.getCurrentItem()));
        editor.putString(getString(R.string.pant), adapter.getCurrentItemData(viewPager.getCurrentItem()));
        editor.commit();
    }
        ...
        if (resultCode == AppCompatActivity.RESULT_OK) {
            ...
            try {
                if (requestCode == SELECT_FILE) {
                    ...
                    //Snackbar.make(getActivity().coordinatorLayout, R.string.issue, Snackbar.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
                // handle error
            }
